...
В ходе проекта я применила SQL к прикладной задаче, освоила программу Power BI, интерпретировала полученные результаты и выдвинула гипотезы для улучшения продукта.
